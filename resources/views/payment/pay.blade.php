...
<head>
    ...
    <link rel="stylesheet" href="{{asset('assets/css/payu.css')}}">
...
<div class="payfrom">
    <div class="main-form position-relative">
        <div class="infyom-logo">
            <img src="{{asset('images/MCSAM-Logo.svg')}}" alt="MCSAM logo">
        </div>
        ...
        <form action="{{$action}}" method="post" name="payuForm" class="pb-0">
            ...
            <div class="px-5 pt-4 pb-5 form-block">
                <div class="row">
                    <div class="col-12">
                        <div class="form-group mb-3 position-relative">
                            <input type="text" class="input-box form-control w-100" placeholder="Name *"
                                   ...
                                   value="{{!empty($posted['firstname']) ? $posted['firstname'] : 'JUNED'}}">
                    ...
                    <div class="col-12">
                        <div class="form-group mb-3 position-relative">
                            <input class="input-box form-control w-100" placeholder="Email *" type="email" name="email"
                                   value="{{!empty($posted['email']) ? $posted['email'] : 'khanjunaid046@gmail.com'}}">
                            <div class="icon-group-append">
                    ...
                    <div class="col-12">
                        <div class="form-group mb-3 position-relative">
                            <input class="input-box form-control w-100" placeholder="Phone *" type="number" name="phone"
                                   value="{{!empty($posted['phone']) ? $posted['phone'] : '8445452656'}}">
                            <div class="icon-group-append">
                    ...
                    <div class="col-12">
                        <div class="form-group mb-3 position-relative">
                            <input class="input-box form-control w-100" placeholder="Amount *" type="text" name="amount"
                                   value="{{!empty($posted['amount']) ? $posted['amount'] : '100'}}">
                            <div class="icon-group-append">
                    ...
                    <div class="col-12">
                        <div class="form-group mb-3 position-relative">
                            <textarea class="input-box form-control w-100" placeholder="Note *" name="productinfo">{{!empty($posted['productinfo']) ? $posted['productinfo'] : 'TEST'}}</textarea>
                            <div class="icon-group-append">
